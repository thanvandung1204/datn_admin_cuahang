...
const ShowAnalitics = ({ data, data2 }: CardThreeProps) => {
  ...
  return (
    <div className='mb-20'>
      ...
      <div className='w-full mt-6 h-[600px] rounded-sm border grid grid-cols-1 border-stroke bg-white pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5'>
        <div className='flex justify-between items-center'>
